...
district_no char(2) NOT NULL,
state_no char(2) NOT NULL,
buyer_contact_no DECIMAL(10,0) NOT NULL REFERENCES buyer(buyer_contact_no) on
...
crop_id TEXT NOT NULL REFERENCES Crop(crop_name) ON UPDATE CASCADE ON
DELETE CASCADE,
village_no CHAR(2) NOT NULL,
district_no CHAR(2) NOT NULL,
state_no CHAR(2) NOT NULL,
quantity INTEGER NOT NULL,
PRIMARY KEY (crop_id, village_no, district_no, state_no),
FOREIGN KEY (village_no, district_no, state_no) REFERENCES Village(village_no,
district_no, state_no)
ON UPDATE CASCADE ON DELETE CASCADE
);
...
references Village(village_no, district_no, state_no),
primary key(required_village_no, required_district_no,
required_state_no,buyer_contact_no)
);
